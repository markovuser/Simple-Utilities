...
{$EXTERNALSYM SCHED_E_START_ON_DEMAND}
  ...
  IID_IRegisteredTaskCollection
    : TGUID = '{86627EB4-42A7-41E4-A4D9-AC33A72F2D52}';
  ...
  IID_ITaskNamedValueCollection
    : TGUID = '{B4EF826B-63C3-46E4-A504-EF69E4F7EA4D}';
  ...
  IID_ISessionStateChangeTrigger
    : TGUID = '{754DA71B-4385-4475-9DD9-598294FA3641}';
...
{$ALIGN 2}
  ...
  ITaskFolder = interface(IDispatch)
    ...
    function CreateFolder(const subFolderName: WideString; sddl: OleVariant)
      : ITaskFolder; safecall;
    procedure DeleteFolder(const subFolderName: WideString;
      flags: Integer); safecall;
    ...
    function RegisterTask(const Path: WideString; const XmlText: WideString;
    ...
    function RegisterTaskDefinition(const Path: WideString;
      const pDefinition: ITaskDefinition; flags: Integer; UserId: OleVariant;
      password: OleVariant; LogonType: _TASK_LOGON_TYPE; sddl: OleVariant)
  ...
  ITaskFolderDisp = dispinterface
    ...
    function CreateFolder(const subFolderName: WideString; sddl: OleVariant)
      : ITaskFolder; dispid 5;
    procedure DeleteFolder(const subFolderName: WideString;
      flags: Integer); dispid 6;
    ...
    function RegisterTask(const Path: WideString; const XmlText: WideString;
      flags: Integer; UserId: OleVariant; password: OleVariant;
      LogonType: _TASK_LOGON_TYPE; sddl: OleVariant): IRegisteredTask;
      dispid 10;
    function RegisterTaskDefinition(const Path: WideString;
      const pDefinition: ITaskDefinition; flags: Integer; UserId: OleVariant;
      password: OleVariant; LogonType: _TASK_LOGON_TYPE; sddl: OleVariant)
      : IRegisteredTask; dispid 11;
    function GetSecurityDescriptor(securityInformation: Integer): WideString;
      dispid 12;
  ...
  IRegisteredTask = interface(IDispatch)
    ...
    procedure GetRunTimes(var pstStart: _SYSTEMTIME; var pstEnd: _SYSTEMTIME;
      var pCount: LongWord; out pRunTimes: PUserType1); safecall;
    property Name: WideString read Get_Name;
    property Path: WideString read Get_Path;
  ...
  IRegisteredTaskDisp = dispinterface
    ...
    function RunEx(params: OleVariant; flags: Integer; sessionID: Integer;
      const user: WideString): IRunningTask; dispid 6;
  ...
  ITaskDefinition = interface(IDispatch)
    ...
    procedure Set_RegistrationInfo(const ppRegistrationInfo
      : IRegistrationInfo); safecall;
  ...
  ITaskSettings = interface(IDispatch)
    ...
    procedure Set_RunOnlyIfNetworkAvailable(pRunOnlyIfNetworkAvailable
      : WordBool); safecall;
    function Get_ExecutionTimeLimit: WideString; safecall;
    procedure Set_ExecutionTimeLimit(const pExecutionTimeLimit
      : WideString); safecall;
    function Get_Enabled: WordBool; safecall;
    procedure Set_Enabled(pEnabled: WordBool); safecall;
    function Get_DeleteExpiredTaskAfter: WideString; safecall;
    procedure Set_DeleteExpiredTaskAfter(const pExpirationDelay
      : WideString); safecall;
    ...
    procedure Set_NetworkSettings(const ppNetworkSettings
      : INetworkSettings); safecall;
    ...
    property MultipleInstances: _TASK_INSTANCES_POLICY
      read Get_MultipleInstances write Set_MultipleInstances;
    property StopIfGoingOnBatteries: WordBool read Get_StopIfGoingOnBatteries
      write Set_StopIfGoingOnBatteries;
    property DisallowStartIfOnBatteries: WordBool
      read Get_DisallowStartIfOnBatteries write Set_DisallowStartIfOnBatteries;
    ...
    property RunOnlyIfNetworkAvailable: WordBool
      read Get_RunOnlyIfNetworkAvailable write Set_RunOnlyIfNetworkAvailable;
    property ExecutionTimeLimit: WideString read Get_ExecutionTimeLimit
      write Set_ExecutionTimeLimit;
    property Enabled: WordBool read Get_Enabled write Set_Enabled;
    property DeleteExpiredTaskAfter: WideString read Get_DeleteExpiredTaskAfter
      write Set_DeleteExpiredTaskAfter;
    property Priority: SYSINT read Get_Priority write Set_Priority;
    property Compatibility: _TASK_COMPATIBILITY read Get_Compatibility
  ...
  IRegisteredTaskCollectionDisp = dispinterface
    ...
    property Item[index: OleVariant]
      : IRegisteredTask readonly dispid 0; default;
    property _NewEnum: IUnknown readonly dispid - 4;
  end;
  ...
  ITaskService = interface(IDispatch)
    ...
    function Connect(serverName: OleVariant; user: OleVariant;
      domain: OleVariant; password: OleVariant): HRESULT; safecall;
  ...
  ITaskServiceDisp = dispinterface
    ...
    procedure Connect(serverName: OleVariant; user: OleVariant;
      domain: OleVariant; password: OleVariant); dispid 4;
  ...
  ITaskHandler = interface(IUnknown)
    ...
    function Start(const pHandlerServices: IUnknown; const Data: WideString)
      : HRESULT; stdcall;
  ...
  ITaskNamedValueCollectionDisp = dispinterface
    ...
    property Item[index: Integer]
      : ITaskNamedValuePair readonly dispid 0; default;
    property _NewEnum: IUnknown readonly dispid - 4;
    function Create(const Name: WideString; const Value: WideString)
      : ITaskNamedValuePair; dispid 2;
  ...
  ISessionStateChangeTrigger = interface(ITrigger)
    ...
    property Delay: WideString read Get_Delay write Set_Delay;
    property UserId: WideString read Get_UserId write Set_UserId;
    property StateChange: _TASK_SESSION_STATE_CHANGE_TYPE read Get_StateChange
  ...
  IEventTrigger = interface(ITrigger)
    ...
    procedure Set_ValueQueries(const ppNamedXPaths
      : ITaskNamedValueCollection); safecall;
  ...
  IExecAction = interface(IAction)
    ...
    procedure Set_WorkingDirectory(const pWorkingDirectory
      : WideString); safecall;
  ...
  IExecAction2 = interface(IExecAction)
    ...
    property HideAppWindow: WordBool read Get_HideAppWindow
      write Set_HideAppWindow;
  end;
  ...
  IEmailAction = interface(IAction)
    ...
    procedure Set_HeaderFields(const ppHeaderFields
      : ITaskNamedValueCollection); safecall;
  ...
  IPrincipal2 = interface(IDispatch)
    ...
    procedure Set_ProcessTokenSidType(pProcessTokenSidType
      : _TASK_PROCESSTOKENSID); safecall;
    ...
    property ProcessTokenSidType: _TASK_PROCESSTOKENSID
      read Get_ProcessTokenSidType write Set_ProcessTokenSidType;
    property RequiredPrivilegeCount: Integer read Get_RequiredPrivilegeCount;
    property RequiredPrivilege[index: Integer]: WideString
      read Get_RequiredPrivilege;
  end;
  ...
  ITaskSettings2 = interface(IDispatch)
    ...
    procedure Set_DisallowStartOnRemoteAppSession(pDisallowStart
      : WordBool); safecall;
    function Get_UseUnifiedSchedulingEngine: WordBool; safecall;
    procedure Set_UseUnifiedSchedulingEngine(pUseUnifiedEngine
      : WordBool); safecall;
    property DisallowStartOnRemoteAppSession: WordBool
      read Get_DisallowStartOnRemoteAppSession
      write Set_DisallowStartOnRemoteAppSession;
    property UseUnifiedSchedulingEngine: WordBool
      read Get_UseUnifiedSchedulingEngine write Set_UseUnifiedSchedulingEngine;
  end;
  ...
  ITaskSettings3 = interface(ITaskSettings)
    ...
    procedure Set_MaintenanceSettings(const ppMaintenanceSettings
      : IMaintenanceSettings); safecall;
    ...
    property UseUnifiedSchedulingEngine: WordBool
      read Get_UseUnifiedSchedulingEngine write Set_UseUnifiedSchedulingEngine;
    property MaintenanceSettings: IMaintenanceSettings
      read Get_MaintenanceSettings write Set_MaintenanceSettings;
...
class function CoTaskScheduler_.CreateRemote(const MachineName: string)
  : ITaskService;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_TaskScheduler_)
    as ITaskService;
end;
...
class function CoTaskHandlerPS.CreateRemote(const MachineName: string)
  : ITaskHandler;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_TaskHandlerPS)
    as ITaskHandler;
end;
...
class function CoTaskHandlerStatusPS.CreateRemote(const MachineName: string)
  : ITaskHandlerStatus;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_TaskHandlerStatusPS)
    as ITaskHandlerStatus;
end;
